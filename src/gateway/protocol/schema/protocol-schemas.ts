...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  SessionsFindParams: SessionsFindParamsSchema,
  SessionsPatchParams: SessionsPatchParamsSchema,
  SessionsResetParams: SessionsResetParamsSchema,
  SessionsDeleteParams: SessionsDeleteParamsSchema,
  SessionsCompactParams: SessionsCompactParamsSchema,
  KgmAdminStatusParams: KgmAdminStatusParamsSchema,
  KgmAdminInitParams: KgmAdminInitParamsSchema,
  KgmAdminEnsureAgentParams: KgmAdminEnsureAgentParamsSchema,
  KgmSchemaDescribeParams: KgmSchemaDescribeParamsSchema,
  KgmAgentSearchParams: KgmAgentSearchParamsSchema,
  KgmAgentGetParams: KgmAgentGetParamsSchema,
  KgmAgentPutNodeParams: KgmAgentPutNodeParamsSchema,
  KgmAgentPutEdgeParams: KgmAgentPutEdgeParamsSchema,
  KgmAgentLinkParams: KgmAgentLinkParamsSchema,
  KgmAgentPinParams: KgmAgentPinParamsSchema,
  KgmAgentTouchParams: KgmAgentTouchParamsSchema,
  KgmAgentGcParams: KgmAgentGcParamsSchema,
  KgmAgentEnsureSchemaParams: KgmAgentEnsureSchemaParamsSchema,
  KgmAgentContextGetParams: KgmAgentContextGetParamsSchema,
  KgmAgentContextPatchParams: KgmAgentContextPatchParamsSchema,
  KgmAgentContextMaterializeParams: KgmAgentContextMaterializeParamsSchema,
